...
{
    [Serializable]
    public class ComparisonScreeningCompleteCommand : CommandBase<ComparisonScreeningCompleteCommand>
    {
#if SILVERLIGHT
        ...
        protected override void DataPortal_Execute()
        {
            using (SqlConnection connection = new SqlConnection(DataConnection.ConnectionString))
            {
                ...
                connection.Open();
                using (SqlCommand command = new SqlCommand("st_ComparisonScreeningComplete", connection))
                {
