...
{
    [Serializable]
    public class SearchNullAbstractCommand : CommandBase<SearchNullAbstractCommand>
    {
#if SILVERLIGHT
    public SearchNullAbstractCommand(){}
        ...
        protected override void DataPortal_Execute()
        {
            using (SqlConnection connection = new SqlConnection(DataConnection.ConnectionString))
            {
                ...
                using (SqlCommand command = new SqlCommand("st_SearchNullAbstract", connection))
                {
                    command.CommandType = System.Data.CommandType.StoredProcedure;
                    command.Parameters.Add(new SqlParameter("@CONTACT_ID", ri.UserId));
                    command.Parameters.Add(new SqlParameter("@REVIEW_ID", ri.ReviewId));
                    command.Parameters.Add(new SqlParameter("@INCLUDED", _included));
                    command.Parameters.Add(new SqlParameter("@SEARCH_TITLE", "Citations without an abstract"));
