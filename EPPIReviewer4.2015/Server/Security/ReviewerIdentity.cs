...
namespace BusinessLibrary.Security
{
    ...
    {
        private static readonly PropertyInfo<int> UserIdProperty = RegisterProperty<int>(typeof(ReviewerIdentity), new PropertyInfo<int>("UserId", "User Id", 0));
        public int UserId
        {
            get
            {
        ...
        private static readonly PropertyInfo<bool> IsSiteAdminProperty = RegisterProperty<bool>(typeof(ReviewerIdentity), new PropertyInfo<bool>("IsSiteAdmin", "IsSiteAdmin", false));
        ...
        private static readonly PropertyInfo<int> ReviewIdProperty = RegisterProperty<int>(typeof(ReviewerIdentity), new PropertyInfo<int>("ReviewId", "Review Id", 0));
        public int ReviewId
        {
#if SILVERLIGHT
            get
        ...
        private static readonly PropertyInfo<string> TicketProperty = RegisterProperty<string>(typeof(ReviewerIdentity), new PropertyInfo<string>("Ticket", "Ticket", 0));
        ...
        private static readonly PropertyInfo<DateTime> AccountExpirationProperty = RegisterProperty<DateTime>(typeof(ReviewerIdentity), new PropertyInfo<DateTime>("AccountExpiration", "AccountExpiration"));
        ...
        private static readonly PropertyInfo<DateTime> ReviewExpirationProperty = RegisterProperty<DateTime>(typeof(ReviewerIdentity), new PropertyInfo<DateTime>("ReviewExpiration", "ReviewExpiration"));
        ...
        private static readonly PropertyInfo<string> LoginModeProperty = RegisterProperty<string>(typeof(ReviewerIdentity), new PropertyInfo<string>("LoginMode", "LoginMode", 0));
    ...
    public int DaysLeftReview
    {
...
#else
        public static void GetIdentity(string username, string password, int reviewId, string LoginMode, string roles)
        {
            GetCslaIdentity<ReviewerIdentity>(new CredentialsCriteria(username, password, reviewId, LoginMode));
        }
        ...
        private void DataPortal_Fetch(CredentialsCriteria criteria)
        {
            ...
            else if (criteria.ArchieState != "" && criteria.ArchieCode != "" && (criteria.Password == null || criteria.Password == ""))
