...
namespace SVM
{
    ...
    internal class Solver
    {
        ...
        public class SolutionInfo
        {
            ...
            public double w_2; // for hyperplane
        }
    ...
    internal class Procedures
    {
        ...
        internal class decision_function
        {
            public double[] alpha;
            public double rho;
            public double w_2; // for hyperplane distance
        };
        ...
        static decision_function svm_train_one(Problem prob, Parameter param, double Cp, double Cn)
        {
            ...
            f.alpha = alpha;
            f.rho = si.rho;
            f.w_2 = si.w_2; // for hyperplane distance
            return f;
        }
        ...
        public static Model svm_train(Problem prob, Parameter param)
        {
            ...
            else
            {
                ...
                {
                    model.Rho[i] = f[i].rho;
                    model.w_2 = f[i].w_2; // for hyperplane distance
                }
        ...
        // for distance to the hyperplane
        public static double distance_to_h(Model model, Node[] x)
        {
            // only works for binary!!
            //int nr_class = model.NumberOfClasses;
            //double[] dec_values = new double[nr_class * (nr_class - 1) / 2]; JT found this expression elsewhere, but not necessary here?
