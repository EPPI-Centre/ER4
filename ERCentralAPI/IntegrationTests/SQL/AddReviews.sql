...
EXEC	@return_value = [dbo].[st_ReviewInsert]
		@REVIEW_NAME = 'Rev10', @CONTACT_ID = 11, @NEW_REVIEW_ID = @NEW_REVIEW_ID OUTPUT


		
EXEC	@return_value = [dbo].[st_ReviewInsert]
		@REVIEW_NAME = 'Shared rev1 (id:12)', @CONTACT_ID = 6, @NEW_REVIEW_ID = @NEW_REVIEW_ID OUTPUT
		
EXEC	@return_value = [dbo].[st_ReviewInsert]
		@REVIEW_NAME = 'Shared rev2 (id:13)', @CONTACT_ID = 7, @NEW_REVIEW_ID = @NEW_REVIEW_ID OUTPUT
...
GO
DECLARE	@return_value int
EXEC	@return_value = st_ReviewAddMember @REVIEW_ID = 12, @CONTACT_ID= 5
...
EXEC	@return_value = st_ReviewAddMember @REVIEW_ID = 12, @CONTACT_ID= 11

EXEC	@return_value = st_ReviewRoleIsAdminUpdate @REVIEW_ID = 12 , @CONTACT_ID = 7, @IS_CHECKED = 1

EXEC	@return_value = st_ReviewAddMember @REVIEW_ID = 13, @CONTACT_ID= 6
...
EXEC	@return_value = st_ReviewAddMember @REVIEW_ID = 13, @CONTACT_ID= 11

EXEC	@return_value = st_ReviewRoleCodingOnlyUpdate @REVIEW_ID = 13 , @CONTACT_ID = 8, @IS_CHECKED = 1
EXEC	@return_value = st_ReviewRoleReadOnlyUpdate @REVIEW_ID = 13 , @CONTACT_ID = 9, @IS_CHECKED = 1
