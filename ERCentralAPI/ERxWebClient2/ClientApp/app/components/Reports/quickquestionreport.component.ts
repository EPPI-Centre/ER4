...
@Component({
    selector: 'quickquestionreport',
    templateUrl: './quickquestionreport.component.html',
})
export class QuickQuestionReportComponent implements OnInit, OnDestroy {
    ...
    public StartQuickReport() {
        if (!this.CanStartReport || !this.QuestionSelector) return;
        else {
            this.ItemCodingService.FetchQuickQuestionReport(this.ItemListService.SelectedItems, this.QuestionSelector.SelectedNodes);
        }
    }
