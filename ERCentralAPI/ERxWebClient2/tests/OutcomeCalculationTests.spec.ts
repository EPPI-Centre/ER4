...
describe('OutcomesService', () => {
	...
	const outcomeInfo: iOutcome =
	{
		...
		"meanDifference": 0,
		"seMeanDifference": 0,
		"petoOR": 0, "sePetoOR": 0, "es": 0.9, "sees": 8, 
	...
	const outcomeInfo1: iOutcome =
	{
		...
		"ciLower": -0.730597981063027, "ciUpper": 1.0747053588439557,
	...
	const outcomeInfo2: iOutcome =
	{
		...
		"sees": 0.6920753239122559, "ciLower": -1.1844139459775573,
	...
	const outcomeInfo3: iOutcome =
	{
		...
		"ciLower": -3.7531142624048455, "ciUpper": 3.7531142624048455,
	...
	const outcomeInfo4: iOutcome =
	{
		...
		"ciLower": -0.7540944236234001, "ciUpper": 1.0501213711543862,
		"esDesc": "SMD", "seDesc": "SE",
		"data1Desc": "Group 1 N",
		"data2Desc": "Group 2 N",
		"data3Desc": "Group 1 mean",
	...
	const outcomeInfo5: iOutcome =
	{
		...
		"sePetoOR": 0, "es": 7.380975123700388, "sees": 2.74165081775551, 
	...
	const outcomeInfo7: iOutcome =
	{
		...
		"es": 0.8, "sees": 0.7071067811865476, "ciLower": -1.3859292911256331,
