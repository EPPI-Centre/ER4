--Script to populate an EMPTY Reviewer database with minimum data.
--This is the SECOND script to run, and Requires to already have a copy of ReviewerAdmin (uses it to create users).
...
INSERT INTO [Reviewer].[dbo].[TB_SOURCE]
           ([SOURCE_NAME]
           ,[REVIEW_ID]
           ,[IS_DELETED]
           ,[DATE_OF_SEARCH]
...
INSERT INTO [Reviewer].[dbo].[TB_ITEM]
           ([TYPE_ID]
           ,[TITLE]
           ,[SHORT_TITLE]
           ,[DATE_CREATED]
     ...
     VALUES
           ...
           ,'1')
GO
INSERT INTO [Reviewer].[dbo].[TB_ITEM_AUTHOR]
           ([ITEM_ID]
           ,[LAST]
           ,[FIRST]
           ,[SECOND]
...
INSERT INTO [Reviewer].[dbo].[TB_ITEM_SOURCE]
           ([ITEM_ID]
           ,[SOURCE_ID])
     VALUES
           ((select top 1 ITEM_ID from TB_ITEM order by ITEM_ID asc)
...
INSERT INTO [Reviewer].[dbo].[TB_ITEM_REVIEW]
           ([ITEM_ID]
           ,[REVIEW_ID]
           ,[IS_INCLUDED]
           ,[IS_DELETED])
     VALUES
           ...
           ,0)
GO
--seeding contacts to high number to avoid clashes with real ER users (better safe than sorry).
...
EXEC	@return_value = [dbo].[st_ContactCreate]
		...
		@USERNAME = N'SuperC',
		@PASSWORD = @SiteAdmPw,
		@DATE_CREATED = N'2008-01-01 12:00:00.000',
...
update Reviewer.dbo.TB_CONTACT set IS_SITE_ADMIN = 1, EXPIRY_DATE = N'2030-01-01 12:00:00.000'
...
update Reviewer.dbo.TB_CONTACT set EXPIRY_DATE = N'2010-01-01 12:00:00.000'
	where CONTACT_ID = @CONTACT_ID
