USE [master]
GO
/****** Object:  Database [AcademicController]    Script Date: 03/09/2019 00:10:59 ******/
...
GO
/****** Object:  User [NT AUTHORITY\SYSTEM]    Script Date: 03/09/2019 00:10:59 ******/
CREATE USER [NT AUTHORITY\SYSTEM] FOR LOGIN [NT AUTHORITY\SYSTEM] WITH DEFAULT_SCHEMA=[db_owner]
GO
ALTER ROLE [db_owner] ADD MEMBER [NT AUTHORITY\SYSTEM]
GO
/****** Object:  SqlAssembly [UserFunctions]    Script Date: 03/09/2019 00:10:59 ******/
...
GO
/****** Object:  UserDefinedFunction [dbo].[fn_PaperAuthors]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[fn_PaperFirstAuthor]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[fn_PaperURLs]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[fn_Split]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  UserDefinedFunction [dbo].[fn_Split_int]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[Jaro]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS OFF
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[LevenshteinDistance]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[LevenshteinSVF]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[ToShortSearchText]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
GO
/****** Object:  StoredProcedure [dbo].[st_AggregateFoSPaperList]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
	...
	SELECT fos.FieldOfStudyId, fos.DisplayName, count(*) n_papers, sum(pfos.Similarity) sum_similarity, avg(pfos.Similarity) avg_similarity from AcademicSmoke.dbo.PaperFieldsOfStudy pfos
...
END
GO
/****** Object:  StoredProcedure [dbo].[st_AuthorPapers]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[st_CurrentMagInfo]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[st_FieldOfStudyPapers]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[st_FieldsOfStudyChildrenList]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[st_FieldsOfStudyParentsList]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[st_FieldsOfStudyRelatedFoSList]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
	...
	select pfos.FieldOfStudyID, fos.DisplayName, count(*) n_papers
		, sum(pfos.Similarity) sum_similarity, avg(pfos.Similarity) avg_similarity
...
END
GO
/****** Object:  StoredProcedure [dbo].[st_FieldsOfStudySearch]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[st_ItemMatchedPapers]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[st_ItemPaperInsert]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Author:		James
-- Create date: 
-- Description:	Pull a limited number of MAG papers into tb_ITEM
-- =============================================
...
BEGIN
	...
	SELECT 
	 ...
	 insert into reviewer.dbo.tb_ITEM_MAG_MATCH(ITEM_ID, REVIEW_ID, PaperId, AutoMatchScore)
	 select item_id, @REVIEW_id, PaperId, 1 from @ItemIds

	 insert into Reviewer.dbo.TB_ITEM_AUTHOR(ITEM_ID, LAST, FIRST, SECOND, ROLE, RANK)
	 select ITEM_ID, right(a.DisplayName, charindex(' ', reverse(a.DisplayName) + '_') - 1),
		left(a.DisplayName, len(a.DisplayName) - charindex(' ', reverse(a.DisplayName) + ' ')), '', 0, paa.AuthorSequenceNumber -1
	 from @ItemIds ids
...
END
GO
/****** Object:  StoredProcedure [dbo].[st_MagMatchItemsRemove]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[st_MagRelatedPapersList]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[st_MagRelatedPapersRun]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[st_MagRelatedPapersRuns]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[st_MagRelatedPapersRunsDelete]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[st_MagRelatedPapersRunsInsert]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
	...
	insert into Reviewer.dbo.tb_MAG_RELATED_RUN(REVIEW_ID, USER_DESCRIPTION, PaperIdList, ATTRIBUTE_ID,
		ALL_INCLUDED, DATE_FROM, AUTO_RERUN, STATUS, MODE, N_PAPERS)
	values(@REVIEW_ID, @USER_DESCRIPTION, @PaperIdList, @ATTRIBUTE_ID,
		@ALL_INCLUDED, @DATE_FROM, @AUTO_RERUN, 'Pending', @MODE, 0)
...
END
GO
/****** Object:  StoredProcedure [dbo].[st_MagRelatedPapersRunsRunUpdates]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[st_MagRelatedPapersWithDateFilter]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
	...
	begin
		...
		insert into Reviewer.dbo.tb_MAG_RELATED_RUN(REVIEW_ID, USER_DESCRIPTION, PaperIdList, ATTRIBUTE_ID, ALL_INCLUDED,
			DATE_FROM, DATE_RUN, AUTO_RERUN, STATUS, PARENT_MAG_RELATED_RUN_ID, MODE, N_PAPERS)
		select REVIEW_ID, USER_DESCRIPTION, PaperIdList, ATTRIBUTE_ID, ALL_INCLUDED,
			DATE_FROM, GETDATE(), 'true', 'Running', @PARENT_MAG_RELATED_RUN_ID, MODE, 0 from Reviewer.dbo.tb_MAG_RELATED_RUN
				where MAG_RELATED_RUN_ID = @MAG_RELATED_RUN_ID
	...
	begin
		...
		left join reviewer.dbo.tb_ITEM_MAG_MATCH imm_filter on imm_filter.PaperId = pr.RecommendedPaperID
		left join Reviewer.dbo.tb_MAG_RELATED_PAPERS mrp on mrp.PaperId = pr.RecommendedPaperID and mrp.PARENT_MAG_RELATED_RUN_ID = @PARENT_MAG_RELATED_RUN_ID
	...
	begin
		...
		left join reviewer.dbo.tb_ITEM_MAG_MATCH imm_filter on imm_filter.PaperId = pr.PaperID
		left join Reviewer.dbo.tb_MAG_RELATED_PAPERS mrp on mrp.PaperId = pr.PaperID and mrp.PARENT_MAG_RELATED_RUN_ID = @PARENT_MAG_RELATED_RUN_ID
		where imm_filter.PaperId is null and mrp.PaperId is null and p.Year >= @DATE_FROM_INT
		group by pr.PaperID
	end
	...
	begin
		...
		inner join @SeedIds spl on spl.PaperId = pr.PaperID
		left join reviewer.dbo.tb_ITEM_MAG_MATCH imm_filter on imm_filter.PaperId = pr.PaperReferenceID
		left join Reviewer.dbo.tb_MAG_RELATED_PAPERS mrp on mrp.PaperId = pr.PaperReferenceID and mrp.PARENT_MAG_RELATED_RUN_ID = @PARENT_MAG_RELATED_RUN_ID
		where imm_filter.PaperId is null and mrp.PaperId is null and p.Year >= @DATE_FROM_INT
...
END
GO
/****** Object:  StoredProcedure [dbo].[st_MatchItemsToPapers]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[st_MatchItemsToPapersSingleItem]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[st_MatchItemsToPapersWithAttribute]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[st_Paper]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[st_PaperCitations]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[st_PaperCitedBy]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[st_PaperFieldsOfStudy]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[st_PaperListById]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[st_PaperRecommendations]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[st_PaperRecommendedBy]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[st_ReviewMagInfo]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[st_ReviewMatchedPapers]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[st_ReviewMatchedPapersWithThisCode]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Testexec]    Script Date: 03/09/2019 00:10:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
