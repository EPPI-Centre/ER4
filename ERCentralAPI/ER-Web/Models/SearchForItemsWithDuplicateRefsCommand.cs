...
{
    [Serializable]
    public class SearchForItemsWithDuplicateRefsCommand : CommandBase<SearchForItemsWithDuplicateRefsCommand>
    {
#if SILVERLIGHT
    public SearchForItemsWithDuplicateRefsCommand(){}
#else
        public SearchForItemsWithDuplicateRefsCommand() { }
#endif
        ...
        public SearchForItemsWithDuplicateRefsCommand(string Title, bool Included)
        {
            _title = Title;
            _included = Included;
        }
        ...
        protected override void DataPortal_Execute()
        {
            using (SqlConnection connection = new SqlConnection(DataConnection.ConnectionString))
            {
                ...
                using (SqlCommand command = new SqlCommand("st_SearchForItemsWithDuplicateReferences", connection))
                {
