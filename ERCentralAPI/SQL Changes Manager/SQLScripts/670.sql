...
BEGIN
	update TB_ROBOT_ACCOUNT set [ENDPOINT] = 'https://gpt34eppi.openai.azure.com/openai/deployments/gpt-4o/chat/completions?api-version=2025-01-01-preview'											
		, IS_PUBLIC = 1
		, PUBLIC_DESCRIPTION = N'This is the first LLM deployed in EPPI Reviewer in 2024. The model used is OpenAI "GPT-4o" with "model version = 2024-08-06". GPT models are optimised for "Chat", making them quicker and more "creative" than reasoning models.'
