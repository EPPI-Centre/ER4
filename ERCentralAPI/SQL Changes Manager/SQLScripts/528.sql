...
/****** Object:  StoredProcedure [dbo].[st_Site_Lic_Add_Remove_Admin_orig]    Script Date: 06/03/2023 11:53:50 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Description:	<Description,,>
-- =============================================
ALTER PROCEDURE [dbo].[st_Site_Lic_Add_Remove_Admin_orig]
	-- Add the parameters for the stored procedure here
	@lic_id int
	,@admin_ID int
	, @contact_id int
...
/****** Object:  StoredProcedure [dbo].[st_Site_Lic_Add_Remove_Contact_orig]    Script Date: 06/03/2023 11:55:07 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER PROCEDURE [dbo].[st_Site_Lic_Add_Remove_Contact_orig]
	-- Add the parameters for the stored procedure here
	@lic_id int
	,@admin_ID int
	, @contact_id int
...
BEGIN
	...
	set @ck2 = (select @acc_all - COUNT(contact_id) from sTB_SITE_LIC_CONTACT where SITE_LIC_ID = @lic_id)
...
/****** Object:  StoredProcedure [dbo].[st_Site_Lic_Add_Review_orig]    Script Date: 06/03/2023 11:56:06 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER PROCEDURE [dbo].[st_Site_Lic_Add_Review_orig]
	-- Add the parameters for the stored procedure here
	@lic_id int
	,@admin_ID int
	, @review_id int
...
BEGIN
	...
	else if  (select count(REVIEW_ID) from sTB_REVIEW where @review_name = REVIEW_NAME and @review_id = REVIEW_ID) != 1
		set @res = -2
...
/****** Object:  StoredProcedure [dbo].[st_Site_Lic_Get_All_orig]    Script Date: 06/03/2023 11:57:14 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER PROCEDURE [dbo].[st_Site_Lic_Get_All_orig] 
...
BEGIN
	...
	SELECT top 1 s_l_a.CONTACT_ID, s_l.SITE_LIC_ID, s_l.SITE_LIC_NAME, s_l.[EXPIRY_DATE], s_l_d.MONTHS 
	FROM sTB_SITE_LIC s_l
	inner join TB_SITE_LIC_DETAILS s_l_d on s_l_d.SITE_LIC_ID = s_l.SITE_LIC_ID
