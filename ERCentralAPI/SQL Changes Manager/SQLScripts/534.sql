...
USE [Reviewer]
GO
If IndexProperty(Object_Id('[dbo].[tb_COMPARISON_ITEM_ATTRIBUTE]'), 'IX_COMPARISON_CID_ITEM_ATT_CONTACT_ARM', 'IndexID') Is Null
  begin
	CREATE NONCLUSTERED INDEX IX_COMPARISON_CID_ITEM_ATT_CONTACT_ARM
	ON [dbo].[tb_COMPARISON_ITEM_ATTRIBUTE] ([COMPARISON_ID])
	INCLUDE ([ITEM_ID],[ATTRIBUTE_ID],[CONTACT_ID],[ITEM_ARM_ID])
  END
GO
