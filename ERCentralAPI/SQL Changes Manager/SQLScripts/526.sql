...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[st_ReviewExtend]') AND type in (N'P', N'PC'))
DROP PROCEDURE st_ReviewExtend 
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[st_ContactExtend]') AND type in (N'P', N'PC'))
DROP PROCEDURE st_ContactExtend
GO

IF NOT EXISTS(SELECT * FROM sys.synonyms where name = 'sTB_SITE_LIC')
 CREATE SYNONYM sTB_SITE_LIC FOR Reviewer.dbo.TB_SITE_LIC;
IF NOT EXISTS(SELECT * FROM sys.synonyms where name = 'sTB_CONTACT')
 CREATE SYNONYM sTB_CONTACT FOR Reviewer.dbo.TB_CONTACT;
IF NOT EXISTS(SELECT * FROM sys.synonyms where name = 'sTB_REVIEW')
 CREATE SYNONYM sTB_REVIEW FOR Reviewer.dbo.TB_REVIEW;
IF NOT EXISTS(SELECT * FROM sys.synonyms where name = 'sTB_ATTRIBUTE_SET')
 CREATE SYNONYM sTB_ATTRIBUTE_SET FOR Reviewer.dbo.TB_ATTRIBUTE_SET;
IF NOT EXISTS(SELECT * FROM sys.synonyms where name = 'sTB_ATTRIBUTE')
 CREATE SYNONYM sTB_ATTRIBUTE FOR Reviewer.dbo.TB_ATTRIBUTE;
IF NOT EXISTS(SELECT * FROM sys.synonyms where name = 'sTB_SITE_LIC_CONTACT')
 CREATE SYNONYM sTB_SITE_LIC_CONTACT FOR Reviewer.dbo.TB_SITE_LIC_CONTACT;
IF NOT EXISTS(SELECT * FROM sys.synonyms where name = 'sTB_SITE_LIC_REVIEW')
 CREATE SYNONYM sTB_SITE_LIC_REVIEW FOR Reviewer.dbo.TB_SITE_LIC_REVIEW;
IF NOT EXISTS(SELECT * FROM sys.synonyms where name = 'sTB_REVIEW_CONTACT')
 CREATE SYNONYM sTB_REVIEW_CONTACT FOR Reviewer.dbo.TB_REVIEW_CONTACT;
IF NOT EXISTS(SELECT * FROM sys.synonyms where name = 'sTB_CONTACT_REVIEW_ROLE')
 CREATE SYNONYM sTB_CONTACT_REVIEW_ROLE FOR Reviewer.dbo.TB_CONTACT_REVIEW_ROLE;
IF NOT EXISTS(SELECT * FROM sys.synonyms where name = 'sTB_SET')
 CREATE SYNONYM sTB_SET FOR Reviewer.dbo.TB_SET;
IF NOT EXISTS(SELECT * FROM sys.synonyms where name = 'sTB_REVIEW_SET')
 CREATE SYNONYM sTB_REVIEW_SET FOR Reviewer.dbo.TB_REVIEW_SET;
IF NOT EXISTS(SELECT * FROM sys.synonyms where name = 'sTB_SET_TYPE')
 CREATE SYNONYM sTB_SET_TYPE FOR Reviewer.dbo.TB_SET_TYPE;
IF NOT EXISTS(SELECT * FROM sys.synonyms where name = 'sTB_ITEM')
 CREATE SYNONYM sTB_ITEM FOR Reviewer.dbo.TB_ITEM;
IF NOT EXISTS(SELECT * FROM sys.synonyms where name = 'sTB_ITEM_REVIEW')
 CREATE SYNONYM sTB_ITEM_REVIEW FOR Reviewer.dbo.TB_ITEM_REVIEW;
IF NOT EXISTS(SELECT * FROM sys.synonyms where name = 'sTB_ITEM_AUTHOR')
 CREATE SYNONYM sTB_ITEM_AUTHOR FOR Reviewer.dbo.TB_ITEM_AUTHOR;
IF NOT EXISTS(SELECT * FROM sys.synonyms where name = 'sTB_SOURCE')
 CREATE SYNONYM sTB_SOURCE FOR Reviewer.dbo.TB_SOURCE;
IF NOT EXISTS(SELECT * FROM sys.synonyms where name = 'sTB_ITEM_SOURCE')
 CREATE SYNONYM sTB_ITEM_SOURCE FOR Reviewer.dbo.TB_ITEM_SOURCE;
IF NOT EXISTS(SELECT * FROM sys.synonyms where name = 'sTB_ITEM_DUPLICATE_GROUP')
 CREATE SYNONYM sTB_ITEM_DUPLICATE_GROUP FOR Reviewer.dbo.TB_ITEM_DUPLICATE_GROUP;
IF NOT EXISTS(SELECT * FROM sys.synonyms where name = 'sTB_ITEM_DUPLICATE_GROUP_MEMBERS')
 CREATE SYNONYM sTB_ITEM_DUPLICATE_GROUP_MEMBERS FOR Reviewer.dbo.TB_ITEM_DUPLICATE_GROUP_MEMBERS;
IF NOT EXISTS(SELECT * FROM sys.synonyms where name = 'sTB_ITEM_SET')
 CREATE SYNONYM sTB_ITEM_SET FOR Reviewer.dbo.TB_ITEM_SET;
IF NOT EXISTS(SELECT * FROM sys.synonyms where name = 'sTB_ITEM_ATTRIBUTE')
 CREATE SYNONYM sTB_ITEM_ATTRIBUTE FOR Reviewer.dbo.TB_ITEM_ATTRIBUTE;
IF NOT EXISTS(SELECT * FROM sys.synonyms where name = 'sTB_ITEM_OUTCOME')
 CREATE SYNONYM sTB_ITEM_OUTCOME FOR Reviewer.dbo.TB_ITEM_OUTCOME;
IF NOT EXISTS(SELECT * FROM sys.synonyms where name = 'sTB_ITEM_OUTCOME_ATTRIBUTE')
 CREATE SYNONYM sTB_ITEM_OUTCOME_ATTRIBUTE FOR Reviewer.dbo.TB_ITEM_OUTCOME_ATTRIBUTE;
IF NOT EXISTS(SELECT * FROM sys.synonyms where name = 'sTB_WORK_ALLOCATION')
 CREATE SYNONYM sTB_WORK_ALLOCATION FOR Reviewer.dbo.TB_WORK_ALLOCATION;
IF NOT EXISTS(SELECT * FROM sys.synonyms where name = 'sTB_DIAGRAM')
 CREATE SYNONYM sTB_DIAGRAM FOR Reviewer.dbo.TB_DIAGRAM;
IF NOT EXISTS(SELECT * FROM sys.synonyms where name = 'sTB_SEARCH')
 CREATE SYNONYM sTB_SEARCH FOR Reviewer.dbo.TB_SEARCH;
IF NOT EXISTS(SELECT * FROM sys.synonyms where name = 'sTB_SEARCH_ITEM')
 CREATE SYNONYM sTB_SEARCH_ITEM FOR Reviewer.dbo.TB_SEARCH_ITEM;
IF NOT EXISTS(SELECT * FROM sys.synonyms where name = 'sTB_ITEM_DOCUMENT')
 CREATE SYNONYM sTB_ITEM_DOCUMENT FOR Reviewer.dbo.TB_ITEM_DOCUMENT;
IF NOT EXISTS(SELECT * FROM sys.synonyms where name = 'sTB_REPORT')
 CREATE SYNONYM sTB_REPORT FOR Reviewer.dbo.TB_REPORT;
IF NOT EXISTS(SELECT * FROM sys.synonyms where name = 'sTB_REPORT_COLUMN')
 CREATE SYNONYM sTB_REPORT_COLUMN FOR Reviewer.dbo.TB_REPORT_COLUMN;
IF NOT EXISTS(SELECT * FROM sys.synonyms where name = 'sTB_REPORT_COLUMN_CODE')
 CREATE SYNONYM sTB_REPORT_COLUMN_CODE FOR Reviewer.dbo.TB_REPORT_COLUMN_CODE;
IF NOT EXISTS(SELECT * FROM sys.synonyms where name = 'sTB_META_ANALYSIS')
 CREATE SYNONYM sTB_META_ANALYSIS FOR Reviewer.dbo.TB_META_ANALYSIS;
IF NOT EXISTS(SELECT * FROM sys.synonyms where name = 'sTB_META_ANALYSIS_OUTCOME')
 CREATE SYNONYM sTB_META_ANALYSIS_OUTCOME FOR Reviewer.dbo.TB_META_ANALYSIS_OUTCOME;
IF NOT EXISTS(SELECT * FROM sys.synonyms where name = 'sTB_ITEM_LINK')
...
IF NOT EXISTS(SELECT * FROM sys.synonyms where name = 'sTB_LOGON_TICKET')
 CREATE SYNONYM sTB_LOGON_TICKET FOR ReviewerAdmin.dbo.TB_LOGON_TICKET;
IF NOT EXISTS(SELECT * FROM sys.synonyms where name = 'sTB_MANAGEMENT_SETTINGS')
 CREATE SYNONYM sTB_MANAGEMENT_SETTINGS FOR ReviewerAdmin.dbo.TB_MANAGEMENT_SETTINGS;
IF NOT EXISTS(SELECT * FROM sys.synonyms where name = 'sTB_TEMPLATE_REVIEW')
 CREATE SYNONYM sTB_TEMPLATE_REVIEW FOR ReviewerAdmin.dbo.TB_TEMPLATE_REVIEW;
IF NOT EXISTS(SELECT * FROM sys.synonyms where name = 'sTB_TEMPLATE_REVIEW_SET')
 CREATE SYNONYM sTB_TEMPLATE_REVIEW_SET FOR ReviewerAdmin.dbo.TB_TEMPLATE_REVIEW_SET;
IF NOT EXISTS(SELECT * FROM sys.synonyms where name = 'sst_LogonTicket_Insert')
 CREATE SYNONYM sst_LogonTicket_Insert FOR ReviewerAdmin.dbo.st_LogonTicket_Insert;
...
SET NOCOUNT ON
      ...
      begin
            ...
            from sTB_ATTRIBUTE_SET a_s 
            inner join sTB_ATTRIBUTE a on a.ATTRIBUTE_ID = a_s.ATTRIBUTE_ID
            where a_s.SET_ID = @SET_ID
...
BEGIN
	...
	select @CHK = count(contact_id) from sTB_CONTACT where CONTACT_ID = @ContactID and EMAIL = @Email
	if @CHK != 1 
	begin 
		set @Result = 'Could not find this Account, please make sure that Account ID and E-Mail address are correct.'
		return
	end
	select @CHK = COUNT(contact_id) from sTB_SITE_LIC_CONTACT where CONTACT_ID = @ContactID 
	if @CHK != 0 
	begin 
...
BEGIN
	...
	select @CHK = count(review_id) from sTB_REVIEW where REVIEW_ID = @revID and REVIEW_NAME = @Rev_name
	if @CHK != 1 
	begin 
		set @Result = 'Could not find this review, please make sure that Review ID and Review Name are correct.'
		return
	end
	select @CHK = COUNT(REVIEW_ID) from sTB_SITE_LIC_REVIEW where REVIEW_ID = @revID 
	if @CHK != 0 
	begin 
...
BEGIN
	...
	From TB_BILL_LINE bl inner join TB_BILL b 
		...
		left outer join sTB_CONTACT c on bl.AFFECTED_ID = c.CONTACT_ID and bl.AFFECTED_ID is not null
	UNION
	select LINE_ID, bl.BILL_ID, bl.FOR_SALE_ID, fs.TYPE_NAME, AFFECTED_ID, MONTHS MONTHS_CREDIT, b.PURCHASER_CONTACT_ID, PRICE_PER_MONTH * MONTHS COST
	...
	From TB_BILL_LINE bl inner join TB_BILL b 
		...
		left outer join sTB_REVIEW r on bl.AFFECTED_ID = r.REVIEW_ID and bl.AFFECTED_ID is not null
	UNION
	select LINE_ID, bl.BILL_ID, bl.FOR_SALE_ID, fs.TYPE_NAME, AFFECTED_ID, MONTHS MONTHS_CREDIT, b.PURCHASER_CONTACT_ID, PRICE_PER_MONTH * MONTHS COST
	, '' as AFFECTED_NAME
	From TB_BILL_LINE bl inner join TB_BILL b 
...
SET NOCOUNT ON
	...
	select * from sTB_REVIEW_CONTACT where CONTACT_ID = @CONTACT_ID and REVIEW_ID = @REVIEW_ID
	if @@ROWCOUNT = 0
	begin
		-- we know they weren't in the review so put them in and make them an admin
		insert into sTB_REVIEW_CONTACT (REVIEW_ID, CONTACT_ID)
		values (@REVIEW_ID, @CONTACT_ID)		
		
		set @review_contact_id = (select REVIEW_CONTACT_ID from sTB_REVIEW_CONTACT
	...
	begin
		...
		select * from sTB_CONTACT_REVIEW_ROLE where REVIEW_CONTACT_ID = @review_contact_id and ROLE_NAME = 'AdminUser'
		if @@ROWCOUNT = 0
		begin
			insert into sTB_CONTACT_REVIEW_ROLE (REVIEW_CONTACT_ID, ROLE_NAME)
			values (@review_contact_id, 'AdminUser')
...
BEGIN
    ...
    -- Insert statements for procedure here
    Declare @Chk int = 0
  --   set @Chk = (select COUNT(Contact_id) from sTB_CONTACT where USERNAME = @USERNAME and CONTACT_ID != @CONTACT_ID)
  --   if @Chk > 0
  --   begin
  ...
  --   else
  --   begin
		set @Chk = (select COUNT(Contact_id) from sTB_CONTACT where EMAIL = @EMAIL and CONTACT_ID != @CONTACT_ID)
		if @Chk > 0 set @RESULT = 'E-Mail is already in use'
		else
		begin
			select @Chk = COUNT(contact_id) from sTB_CONTACT where [EXPIRY_DATE] is null and PWASHED is null and CONTACT_ID = @CONTACT_ID
			if @Chk = 0
			begin
			...
			begin
				set @RESULT = 'Valid'
				update sTB_CONTACT set [EMAIL] = @EMAIL where CONTACT_ID = @CONTACT_ID
			end
...
SET NOCOUNT ON
                ...
                select s.SET_ID, s.SET_NAME, st.SET_TYPE from sTB_SET s 
                inner join sTB_REVIEW_SET rs
                on s.SET_ID = rs.SET_ID
                inner join sTB_SET_TYPE st
...
SET NOCOUNT ON
	...
	select @creator_id = CREATOR_ID from sTB_CONTACT where CONTACT_ID = @CONTACT_ID
	...
	begin 
		Select @CID = CONTACT_ID, @Email = EMAIL, @CONTACT_NAME = CONTACT_NAME, 
					@IS_ACTIVE = CASE 
							...
							ELSE 1
						END
		  from sTB_CONTACT where @Uname = USERNAME
	End
	ELSE
	begin 
		...
		BEGIN
			Select @CID = CONTACT_ID, @CONTACT_NAME = CONTACT_NAME, @Uname = USERNAME, 
					@IS_ACTIVE = CASE 
							...
							ELSE 1
						END
		   from sTB_CONTACT where @Email = EMAIL
		END
		ELSE 
		BEGIN 
			...
			BEGIN
				Select @CID = CONTACT_ID, @CONTACT_NAME = CONTACT_NAME, 
						@IS_ACTIVE = CASE 
							...
							ELSE 1
						END
		   from sTB_CONTACT where @Email = EMAIL and @Uname = USERNAME
			END
		END
	END
...
AS
	...
	INSERT INTO sTB_CONTACT(CONTACT_NAME, USERNAME, DATE_CREATED, [EXPIRY_DATE], EMAIL, DESCRIPTION
										,FLAVOUR, PWASHED)
	...
	update sTB_CONTACT set CREATOR_ID = @NEW_CONTACT_ID
	where CONTACT_ID = @NEW_CONTACT_ID
	
	select @CONTACT_ID = CONTACT_ID from sTB_CONTACT where CONTACT_ID = @NEW_CONTACT_ID
...
declare @EXISTING_USERNAME nvarchar(50) 
	...
	begin
		...
		set @EXISTING_USERNAME = (select @USERNAME from sTB_CONTACT
		where CONTACT_ID = @CONTACT_ID)
...
BEGIN
	...
	begin        		
		if @SiteLicence != '0'
		begin			
			select c.CONTACT_ID, c.CONTACT_NAME, c.EMAIL from sTB_CONTACT c
              inner join sTB_SITE_LIC_CONTACT lc on c.CONTACT_ID = lc.CONTACT_ID and lc.SITE_LIC_ID = @SiteLicence
              where ((c.CONTACT_ID like '%' + @TEXT_BOX + '%') OR
				(c.CONTACT_NAME like '%' + @TEXT_BOX + '%') OR
				(c.EMAIL like '%' + @TEXT_BOX + '%'))		
...
select r.REVIEW_ID, r.REVIEW_NAME, r.FUNDER_ID, 
     ...
     , l.SITE_LIC_ID, l.SITE_LIC_NAME
	from sTB_REVIEW r
	left outer join sTB_SITE_LIC_REVIEW lr on r.REVIEW_ID = lr.REVIEW_ID
	left outer join sTB_SITE_LIC l on lr.SITE_LIC_ID = l.SITE_LIC_ID
    ...
    , l.SITE_LIC_ID, l.SITE_LIC_NAME   
	from sTB_REVIEW r
	inner join sTB_REVIEW_CONTACT rc
...
BEGIN
	...
	from sTB_CONTACT_REVIEW_ROLE c_r_r
	inner join sTB_REVIEW_CONTACT r_c on r_c.REVIEW_CONTACT_ID = c_r_r.REVIEW_CONTACT_ID
...
BEGIN
	...
	from sTB_REVIEW r
	inner join sTB_REVIEW_CONTACT r_c on r_c.REVIEW_ID = r.REVIEW_ID
	inner join sTB_CONTACT c on c.CONTACT_ID = r_c.CONTACT_ID
	left outer join TB_LOGON_TICKET t on t.REVIEW_ID = r_c.REVIEW_ID and t.CONTACT_ID = r_c.CONTACT_ID
	where r_c.CONTACT_ID = @CONTACT_ID
...
BEGIN
    ...
    -- Insert statements for procedure here
	SELECT * from sTB_CONTACT
		WHERE sTB_CONTACT.CONTACT_ID = @CONTACT_ID	
	RETURN
END
GO
...
BEGIN
    ...
    -- Insert statements for procedure here
	SELECT * from sTB_CONTACT
		WHERE sTB_CONTACT.USERNAME = @USERNAME	
	RETURN
END
GO
...
BEGIN
    ...
    -- Insert statements for procedure here
	Delete from sTB_CONTACT where CONTACT_ID = @CID and [USERNAME] = @USERNAME
END
...
insert into @tb_review_name (review_name1)select CONTACT_NAME from sTB_CONTACT where CONTACT_ID = @CONTACT_ID
...
--02 create new row in sTB_REVIEW_CONTACT
	insert into sTB_REVIEW_CONTACT (REVIEW_ID, CONTACT_ID)
	values (@NEW_REVIEW_ID, @CONTACT_ID)
	set @REVIEW_CONTACT_ID = CAST(SCOPE_IDENTITY() AS INT)
	
--03 create new row in sTB_CONTACT_REVIEW_ROLE
	insert into sTB_CONTACT_REVIEW_ROLE (REVIEW_CONTACT_ID, ROLE_NAME)
	values (@REVIEW_CONTACT_ID, 'AdminUser')
...
--01 collect the data for @tb_item_duplicate_group
	...
	i_d_g.ORIGINAL_ITEM_ID from sTB_ITEM_DUPLICATE_GROUP i_d_g
	where i_d_g.REVIEW_ID = @SOURCE_REVIEW_ID

	update t1
	set t1.new_original_item_id = t2.ITEM_ID
	from @tb_item_duplicate_group t1 inner join sTB_ITEM t2
...
--02 collect the data for @tb_item_duplicate_group_members
	...
	i_d_g_m.SCORE, i_d_g_m.IS_CHECKED, i_d_g_m.IS_DUPLICATE from sTB_ITEM_DUPLICATE_GROUP_MEMBERS i_d_g_m
	...
	from @tb_item_duplicate_group_members t1 inner join sTB_ITEM_REVIEW t2
	on t1.old_item_review_id = t2.ITEM_REVIEW_ID
	
	update t1
	set t1.new_item_id = t2.ITEM_ID
	from @tb_item_duplicate_group_members t1 inner join sTB_ITEM t2
	on t2.OLD_ITEM_ID = t1.old_item_id
	where t2.ITEM_ID in (select ITEM_ID from sTB_ITEM_REVIEW i_r
	where i_r.REVIEW_ID = @NEW_REVIEW_ID)
...
--03 create new rows in sTB_ITEM_DUPLICATE_GROUP
	...
	while @@FETCH_STATUS = 0
	begin
		insert into sTB_ITEM_DUPLICATE_GROUP (REVIEW_ID, ORIGINAL_ITEM_ID)	
...
--04 create new rows in sTB_ITEM_DUPLICATE_GROUP_MEMBERS
	...
	while @@FETCH_STATUS = 0
	begin
		insert into sTB_ITEM_DUPLICATE_GROUP_MEMBERS (ITEM_DUPLICATE_GROUP_ID, ITEM_REVIEW_ID,
...
--05 update sTB_ITEM_DUPLICATE_GROUP with the new MASTER_MEMBER_ID	
	update t1
	set t1.MASTER_MEMBER_ID = t2.new_master_member_id
	from sTB_ITEM_DUPLICATE_GROUP t1 inner join @tb_item_duplicate_group t2
...
--01 copy the work assignments
	...
	from sTB_WORK_ALLOCATION w_s
	where w_s.REVIEW_ID = @SOURCE_REVIEW_ID

	update t1
	set new_set_id = t2.SET_ID
	from @tb_work_allocation t1 inner join sTB_SET t2
	on t2.OLD_GUIDELINE_ID = t1.old_set_id
	where t2.SET_ID in (select SET_ID from sTB_REVIEW_SET r_s
	where r_s.REVIEW_ID = @DESTINATION_REVIEW_ID)
	
	update t1
	set new_attribute_id = t2.ATTRIBUTE_ID
	from @tb_work_allocation t1 inner join sTB_ATTRIBUTE t2
	on t2.OLD_ATTRIBUTE_ID = t1.old_attribute_id
	where t2.ATTRIBUTE_ID in (select ATTRIBUTE_ID from sTB_ATTRIBUTE_SET a_s
	where a_s.SET_ID in (select SET_ID from sTB_REVIEW_SET r_s
	where r_s.REVIEW_ID = @DESTINATION_REVIEW_ID))
	
	insert into sTB_WORK_ALLOCATION (CONTACT_ID, REVIEW_ID, SET_ID, ATTRIBUTE_ID)
	select @CONTACT_ID, @DESTINATION_REVIEW_ID, w_a.new_set_id, w_a.new_attribute_id  
	from @tb_work_allocation w_a

--02 copy diagrams
	insert into sTB_DIAGRAM (REVIEW_ID, DIAGRAM_NAME, DIAGRAM_DETAIL)
...
--03 copy searches
	...
	update t1
	set new_item_id = t2.ITEM_ID
	from @tb_search_item t1 inner join sTB_ITEM t2
	on t2.OLD_ITEM_ID = t1.old_item_id
	where t2.ITEM_ID in (select ITEM_ID from sTB_ITEM_REVIEW i_r
	...
	while @@FETCH_STATUS = 0
	begin
		insert into sTB_SEARCH (REVIEW_ID, CONTACT_ID, SEARCH_TITLE, SEARCH_NO, ANSWERS, HITS_NO, SEARCH_DATE)	
		...
		insert into sTB_SEARCH_ITEM (ITEM_ID, SEARCH_ID, ITEM_RANK)
...
--04 copy pdfs
	...
	from sTB_ITEM_DOCUMENT i_d
	where i_d.ITEM_ID in (select ITEM_ID from sTB_ITEM_REVIEW
	where REVIEW_ID = @SOURCE_REVIEW_ID)
	
	update t1
	set new_item_id = t2.ITEM_ID
	from @tb_item_document t1 inner join sTB_ITEM t2
	on t2.OLD_ITEM_ID = t1.old_item_id
	where t2.ITEM_ID in (select ITEM_ID from sTB_ITEM_REVIEW i_r
	where i_r.REVIEW_ID = @DESTINATION_REVIEW_ID) 
...
--select * from @tb_item_document
	...
	while @@FETCH_STATUS = 0
	begin
		insert into sTB_ITEM_DOCUMENT (ITEM_ID, DOCUMENT_TITLE, DOCUMENT_BINARY, 
...
(new_report_id bigint, old_report_id bigint, name nvarchar(255), report_type nvarchar(10))
	...
	while @@FETCH_STATUS = 0
	begin
		insert into sTB_REPORT (REVIEW_ID, CONTACT_ID, NAME, REPORT_TYPE)	
...
--select * from @tb_report_column	
	...
	while @@FETCH_STATUS = 0
	begin
		insert into sTB_REPORT_COLUMN (REPORT_ID, REPORT_COLUMN_NAME, COLUMN_ORDER)	
...
user_def_text nvarchar(255), display_code bit, display_additional_text bit, display_coded_text bit)
	...
	from sTB_REPORT_COLUMN_CODE r_c_c
...
--select * from @tb_report_column_code
	...
	from sTB_SET s inner join @tb_report_column_code r_c_c
	on s.OLD_GUIDELINE_ID = r_c_c.old_set_id
	where s.SET_ID in (select r_s.SET_ID from sTB_REVIEW_SET r_s
	where r_s.REVIEW_ID = @DESTINATION_REVIEW_ID)
...
--select * from @tb_report_column_code
	...
	from sTB_ATTRIBUTE a inner join @tb_report_column_code r_c_c
	on a.OLD_ATTRIBUTE_ID = r_c_c.old_attribute_id
	where a.ATTRIBUTE_ID in (select a_s.ATTRIBUTE_ID from sTB_ATTRIBUTE_SET a_s
	where a_s.SET_ID in (select SET_ID from sTB_REVIEW_SET r_s
	where r_s.REVIEW_ID = @DESTINATION_REVIEW_ID))
...
--select * from @tb_report_column_code
	...
	from sTB_ATTRIBUTE_SET a_s inner join @tb_report_column_code r_c_c
...
--select * from @tb_report_column_code	
	...
	insert into sTB_REPORT_COLUMN_CODE (REPORT_ID, REPORT_COLUMN_ID, CODE_ORDER, 
...
--select * from @tb_meta_analysis
	...
	update m_a
	set new_set_id = s.SET_ID
	from sTB_SET s inner join @tb_meta_analysis m_a
...
--select * from @tb_meta_analysis
	...
	update m_a
	set new_attribute_id = a.ATTRIBUTE_ID
	from sTB_ATTRIBUTE a inner join @tb_meta_analysis m_a
...
--select * from @tb_meta_analysis
	...
	while @@FETCH_STATUS = 0
	begin
		insert into sTB_META_ANALYSIS (META_ANALYSIS_TITLE, CONTACT_ID, 
...
(new_meta_analysis_id int, old_meta_analysis_id int, 
 new_outcome_id int, old_outcome_id int)
	...
	from sTB_META_ANALYSIS_OUTCOME m_a_o
	where m_a_o.META_ANALYSIS_ID in (select META_ANALYSIS_ID from 
	sTB_META_ANALYSIS where REVIEW_ID = @SOURCE_REVIEW_ID)
...
--- of creation (in an earlier st_ ) and hold it externally in TB_REVIEW_COPY_DATA
--- until I need it.

	update m_a_o
	set m_a_o.new_outcome_id = r_c_d.NEW_OUTCOME_ID
	from TB_REVIEW_COPY_DATA r_c_d inner join @tb_meta_analysis_outcome m_a_o
	on r_c_d.OLD_OUTCOME_ID = m_a_o.old_outcome_id
	where r_c_d.NEW_REVIEW_ID = @DESTINATION_REVIEW_ID
	
--select * from @tb_meta_analysis_outcome	

	insert into sTB_META_ANALYSIS_OUTCOME 
...
insert into @tb_item_link (old_item_link_id, old_item_id_primary, 
	...
	from sTB_ITEM_LINK i_l
	where i_l.ITEM_ID_PRIMARY in (select ITEM_ID from sTB_ITEM_REVIEW
	where REVIEW_ID = @SOURCE_REVIEW_ID)
...
--select * from @tb_item_link
	...
	from @tb_item_link t1 inner join sTB_ITEM t2
...
--select * from @tb_item_link
	...
	while @@FETCH_STATUS = 0
	begin
		insert into sTB_ITEM_LINK (ITEM_ID_PRIMARY, ITEM_ID_SECONDARY,
		LINK_DESCRIPTION)	
...
--01 clean up TB_ATTRIBUTE
	...
	set OLD_ATTRIBUTE_ID = null
	where ATTRIBUTE_ID in 
	(select a.ATTRIBUTE_ID from sTB_ATTRIBUTE a
	inner join sTB_ATTRIBUTE_SET a_s on a_s.ATTRIBUTE_ID = a.ATTRIBUTE_ID
	inner join sTB_REVIEW_SET r_s on r_s.SET_ID = a_s.SET_ID
	where r_s.REVIEW_ID = @DESTINATION_REVIEW_ID)
...
--02 clean up TB_SET
	...
	where SET_ID in 
	(select s.SET_ID from  sTB_SET s
	inner join sTB_REVIEW_SET r_s on r_s.SET_ID = s.SET_ID
	where r_s.REVIEW_ID = @DESTINATION_REVIEW_ID)
...
--03 clean up TB_ITEM
	...
	where ITEM_ID in
	(select i_r.ITEM_ID from sTB_ITEM_REVIEW i_r
	where i_r.REVIEW_ID = @DESTINATION_REVIEW_ID)
	
--03 clean up TB_REVIEW_COPY_DATA
	delete from TB_REVIEW_COPY_DATA
...
select @contact_name = CONTACT_NAME from sTB_CONTACT where CONTACT_ID = @CONTACT_ID
set @review_name = @contact_name + '''s example non-shareable review'
	...
	and REVIEW_ID in (select REVIEW_ID from sTB_REVIEW_CONTACT
	where CONTACT_ID = @CONTACT_ID)
...
BEGIN
	...
	inner join sTB_CONTACT c on c.CONTACT_ID = cp.PURCHASER_CONTACT_ID
    ...
    -- Insert statements for procedure here
		select c.CONTACT_NAME, c.CONTACT_ID, c.EMAIL, ed.*, et.EXTENSION_TYPE 
		 ...
		 , case 
			...
			END
			AS [Ј]
		from sTB_REVIEW_CONTACT rc 
		inner join sTB_CONTACT c on rc.REVIEW_ID = @r and rc.CONTACT_ID = c.CONTACT_ID
...
BEGIN
	...
	select WEBDB_ID, WEBDB_NAME, REVIEW_ID, CREATED_BY, IS_OPEN from sTB_WEBDB
...
SET NOCOUNT ON
	...
	set @WEBDB_NAME = (select WEBDB_NAME from sTB_WEBDB where WEBDB_ID = @WEBDB_ID)
	set @REVIEW_ID = (select REVIEW_ID from sTB_WEBDB where WEBDB_ID = @WEBDB_ID)
...
BEGIN TRANSACTION
	...
	update sTB_CONTACT set EXPIRY_DATE = DATEADD(day, @NUMBER_DAYS, EXPIRY_DATE) 
	...
	update sTB_REVIEW set EXPIRY_DATE = DATEADD(day, @NUMBER_DAYS, EXPIRY_DATE) 
	where EXPIRY_DATE >= @DATE
	...
	update sTB_SITE_LIC set EXPIRY_DATE = DATEADD(day, @NUMBER_DAYS, EXPIRY_DATE) 
	where EXPIRY_DATE >= @DATE
...
BEGIN
	...
	inner join sTB_CONTACT c on c.CONTACT_ID = e_e_l.EXTENDED_BY_ID
...
BEGIN
    ...
    -- Insert statements for procedure here
    select c.CONTACT_ID, c.CONTACT_NAME from sTB_CONTACT c
    inner join sTB_REVIEW r on r.FUNDER_ID = c.CONTACT_ID
...
AS
	declare @chk int = 0
	select @RES = 'Done'
	select @chk = COUNT(CONTACT_ID) from sTB_CONTACT where CONTACT_ID = @CONTACT_ID
	if @chk = 0
	begin
	...
	Select @chk = COUNT(contact_id) from sTB_CONTACT where CONTACT_ID = @CONTACT_ID and EXPIRY_DATE is not null
	if @chk != 1
	BEGIN --not good
...
BEGIN
	...
	if @@ROWCOUNT > 0
	begin
		Update sTB_CONTACT set EMAIL = null where CONTACT_ID = @CONTACT_ID and FLAVOUR is null and EXPIRY_DATE is null
	end
END
...
BEGIN
	...
	if @Name = ''
	begin
		update sTB_REVIEW set EXPIRY_DATE = DATEADD(month,MONTHS_CREDIT, GETDATE())
	...
	select @months_credit = MONTHS_CREDIT from sTB_REVIEW where REVIEW_ID = @revID 
	update sTB_REVIEW set MONTHS_CREDIT = 0 where REVIEW_ID = @revID 

	select @funderID = FUNDER_ID from sTB_REVIEW where REVIEW_ID = @revID
...
BEGIN
    ...
    declare @chk int = 0
    set @chk = (select COUNT(CONTACT_ID) from sTB_CONTACT where CONTACT_ID = @cid and IS_SITE_ADMIN = 1)
    if @chk != 1 return 
...
--set @ITEM_ID = (select ITEM_ID from sTB_ITEM where OLD_ITEM_ID = @OLD_ITEM_ID)
set @ITEM_ID = (select i.ITEM_ID from sTB_ITEM i
inner join sTB_ITEM_REVIEW i_r on i_r.ITEM_ID = i.ITEM_ID
where i_r.REVIEW_ID = @DESTINATION_REVIEW_ID
...
INSERT INTO sTB_ITEM_DOCUMENT(ITEM_ID, DOCUMENT_TITLE, DOCUMENT_EXTENSION, DOCUMENT_BINARY/*, DOCUMENT_TEXT*/)
...
BEGIN TRANSACTION
	...
	insert into sTB_REVIEW_SET (REVIEW_ID, SET_ID, ALLOW_CODING_EDITS, CODING_IS_FINAL, SET_ORDER)
...
BEGIN
	...
	if @TEST_SEND = 0
	BEGIN
		select CONTACT_ID, CONTACT_NAME, EMAIL from sTB_CONTACT
...
BEGIN
	...
	and CONTACT_ID in (select CONTACT_ID from sTB_CONTACT where SEND_NEWSLETTER = 1)
	...
	select COUNT(CONTACT_ID) from sTB_CONTACT
	where SEND_NEWSLETTER = 1
	and CONTACT_ID != @EPPIsupportID
	...
	update @tb_newsletter_status
	set numToBeSent = (select COUNT(CONTACT_ID) from sTB_CONTACT
	where SEND_NEWSLETTER = 1
	and CONTACT_ID != @EPPIsupportID
...
inner join sTB_CONTACT c on f.CONTACT_ID = c.CONTACT_ID
...
BEGIN
	...
	select @contact_id = CONTACT_ID from sTB_CONTACT where EMAIL = @contact_email and EXPIRY_DATE > '2010-03-20 00:00:01'
	if @@ROWCOUNT = 1 
	begin
		declare @ck int
		set @ck = (SELECT count(contact_id) from TB_ORGANISATION_ADMIN 
		where (CONTACT_ID = @admin_ID or @admin_ID in (select CONTACT_ID from sTB_CONTACT where CONTACT_ID = @admin_ID and IS_SITE_ADMIN = 1
		...
		else if  (select count(contact_id) from sTB_CONTACT where @contact_email = EMAIL 
			and @contact_id = CONTACT_ID
	...
	--	inner join sTB_CONTACT c on a.CONTACT_ID = c.CONTACT_ID
...
BEGIN
	...
	begin
		...
		set @ck = (SELECT count(contact_id) from TB_ORGANISATION_ADMIN 
			where (CONTACT_ID = @admin_ID or @admin_ID in 
				(select CONTACT_ID from sTB_CONTACT where CONTACT_ID = @admin_ID and IS_SITE_ADMIN = 1)) 
			and ORGANISATION_ID = @org_id)
		...
		--set @ck2 = (select @acc_all - COUNT(contact_id) from sTB_SITE_LIC_CONTACT 
		--	where SITE_LIC_ID = @lic_id)
		if @ck < 1 set @res = -1 --first check: see if supplied admin id is actually an admin!
		
		--else if  (select count(contact_id) from sTB_SITE_LIC_CONTACT 
	...
	--select c.CONTACT_ID, CONTACT_NAME, EMAIL from sTB_SITE_LIC_CONTACT lc 
	--	inner join sTB_CONTACT c on lc.CONTACT_ID = c.CONTACT_ID
	--	where SITE_LIC_ID = @lic_id
...
BEGIN
    ...
    select @review_name = REVIEW_NAME from sTB_REVIEW where REVIEW_ID = @review_id
	if @@ROWCOUNT = 1 
	begin
		declare @ck int, @ck2 int, @org_det_id int
		set @ck = (SELECT count(contact_id) from TB_ORGANISATION_ADMIN 
		where (CONTACT_ID = @admin_ID or @admin_ID in (select CONTACT_ID from sTB_CONTACT 
		...
		begin
			...
			--set @org_det_id = (SELECT TOP 1 ld.SITE_LIC_DETAILS_ID from sTB_SITE_LIC sl 
			...
			--				 sTB_SITE_LIC_REVIEW lr on lr.SITE_LIC_DETAILS_ID = @org_det_id
			...
			begin --all is well, let's do something!
				...
				update sTB_REVIEW set ORGANISATION_ID = @org_id
					where REVIEW_ID = @review_id
	...
	--select r.review_id, review_name from sTB_SITE_LIC_REVIEW lr
	--	inner join sTB_REVIEW r on lr.REVIEW_ID = r.REVIEW_ID
	--	where SITE_LIC_ID = @lic_id
...
(
	...
	update @Organisation
	set CREATOR_NAME = 
	(select CONTACT_NAME from sTB_CONTACT
	...
	BEGIN	
		...
		BEGIN
			...
			begin
				...
				update @Organisations
				set CONTACT_NAME = 
				(select CONTACT_NAME from sTB_CONTACT c
...
BEGIN
	...
	(select count(REVIEW_ID) from sTB_REVIEW 
	...
	begin
		...
		--set @lic_det_id = 
		--(SELECT TOP 1 ld.SITE_LIC_DETAILS_ID from sTB_SITE_LIC sl 
		--	inner join TB_SITE_LIC_DETAILS ld on sl.SITE_LIC_ID = ld.SITE_LIC_ID and ld.VALID_FROM is not null
		--	inner join TB_FOR_SALE fs on ld.FOR_SALE_ID = fs.FOR_SALE_ID and fs.IS_ACTIVE = 0
		--	Order by ld.VALID_FROM desc)
		...
		begin --all is well, let's do something!
			...
			update sTB_REVIEW set ORGANISATION_ID = 0
					where REVIEW_ID = @review_id
...
BEGIN
	...
	inner join sTB_CONTACT c on c.CONTACT_ID = o_f.ACCOUNT_ID
...
BEGIN
	...
	Inner JOIN sTB_CONTACT c on t.CONTACT_ID = c.CONTACT_ID      
	Inner Join sTB_REVIEW r on r.REVIEW_ID = t.REVIEW_ID      
...
SET NOCOUNT ON
    ...
    set @det_id = (select top 1 ld.SITE_LIC_DETAILS_ID from TB_SITE_LIC_DETAILS ld 
       ...
       select r.REVIEW_ID from sTB_REVIEW r
              inner join sTB_SITE_LIC_REVIEW lr on r.REVIEW_ID = lr.REVIEW_ID and SITE_LIC_ID = @SITE_LIC_ID and SITE_LIC_DETAILS_ID != @det_id

		delete from sTB_SITE_LIC_REVIEW where REVIEW_ID = (select tv_review_id from @reviewList)
...
BEGIN
    ...
    -- Insert statements for procedure here
	SELECT @RES = COUNT(c.CONTACT_ID) from sTB_CONTACT c
...
BEGIN
	...
	begin
		select @old_contact_id = old_contact_id from sTB_CONTACT
		where CONTACT_ID = @CONTACT_ID

		insert into sTB_REVIEW_CONTACT (REVIEW_ID, CONTACT_ID, old_review_id, old_contact_id)
...
BEGIN
	...
	FROM stb_CONTACT c
	INNER JOIN stb_REVIEW_CONTACT r_c ON c.CONTACT_ID = r_c.CONTACT_ID
	AND r_c.REVIEW_ID = @REVIEW_ID
...
BEGIN TRANSACTION
	...
	begin
		-- create a new account
		INSERT INTO sTB_REVIEW(REVIEW_NAME, DATE_CREATED, [EXPIRY_DATE], MONTHS_CREDIT, REVIEW_NUMBER, FUNDER_ID)
...
SET NOCOUNT ON
	...
	delete sTB_CONTACT_REVIEW_ROLE from sTB_CONTACT_REVIEW_ROLE crr
    inner join sTB_REVIEW_CONTACT rc
    on rc.REVIEW_CONTACT_ID = crr.REVIEW_CONTACT_ID
    and rc.CONTACT_ID = @CONTACT_ID
    and rc.REVIEW_ID = @REVIEW_ID
                
    delete from sTB_REVIEW_CONTACT 
    where CONTACT_ID = @CONTACT_ID
    and REVIEW_ID = @REVIEW_ID
...
SET NOCOUNT ON
	...
	select @funder_id = FUNDER_ID from sTB_REVIEW
	where REVIEW_ID = @REVIEW_ID
...
SET NOCOUNT ON
	...
	-- get REVIEW_CONTACT_ID
	select @REVIEW_OWNER = FUNDER_ID from sTB_REVIEW
		where REVIEW_ID = @REVIEW_ID
	...
	begin
		...
		begin
			...
			select REVIEW_CONTACT_ID from sTB_CONTACT_REVIEW_ROLE
			where REVIEW_CONTACT_ID = @REVIEW_CONTACT_ID
			and ROLE_NAME = 'RegularUser'
			if @@ROWCOUNT = 0
			begin
...
BEGIN
	...
	set @check = (
				select count(sld.SITE_LIC_DETAILS_ID) from sTB_SITE_LIC sl 
					...
					inner join TB_SITE_LIC_ADMIN la on sl.SITE_LIC_ID = la.SITE_LIC_ID and 
						...
						@admin_ID in (select CONTACT_ID from sTB_CONTACT where CONTACT_ID = @admin_ID and IS_SITE_ADMIN = 1)
						)
				)
	...
	BEGIN TRANSACTION
		...
		set @months = (select  d.MONTHS from TB_SITE_LIC_DETAILS d
						inner join sTB_SITE_LIC l on l.SITE_LIC_ID = d.SITE_LIC_ID
...
BEGIN
    ...
    -- Insert statements for procedure here
    declare @ck int = 0
    set @ck = (SELECT COUNT(contact_id) from sTB_CONTACT where CONTACT_ID = @creator_id and IS_SITE_ADMIN = 1)
    if @ck <1 return -1 --only site_admins can create new site licenses!
	declare @L_ID int, @FS_ID int
	insert into sTB_SITE_LIC 
		(
		SITE_LIC_NAME
		, COMPANY_NAME
		, COMPANY_ADDRESS
...
BEGIN
    ...
    -- initial check to see if email exists
	select @contact_id = CONTACT_ID from sTB_CONTACT where EMAIL = @contact_email
	if @@ROWCOUNT = 1 
	begin
		declare @ck int
		...
		if @ck < 1 set @res = -1 --first check: see if supplied admin is actually and admin!
		else if  (select count(contact_id) from sTB_CONTACT where @contact_email = EMAIL and @contact_id = CONTACT_ID) != 1
			--second check, see if c_id and email exist
			set @res = -2
		else -- checks went OK, let's see if we can do it
		begin
...
BEGIN
	...
	begin
		...
		begin
			set @ck = (select count(contact_id) from sTB_SITE_LIC_CONTACT where CONTACT_ID = @contact_id)
			if @ck = 1 -- contact is in the license, we should remove it
			begin
				delete from sTB_SITE_LIC_CONTACT where CONTACT_ID = @contact_id and @lic_id = SITE_LIC_ID
				if @@ROWCOUNT = 1
				begin --write success log
					insert into TB_SITE_LIC_LOG (
						[SITE_LIC_DETAILS_ID]
			...
			begin
				insert into sTB_SITE_LIC_CONTACT (CONTACT_ID, SITE_LIC_ID)
				values (@contact_id, @lic_id)
				if @@ROWCOUNT = 1
				begin
					insert into TB_SITE_LIC_LOG (
...
BEGIN
	...
	begin
		...
		begin
			set @ck = (select count(review_id) from sTB_SITE_LIC_REVIEW where REVIEW_ID = @review_id)
			set @lic_det_id = (SELECT TOP 1 ld.SITE_LIC_DETAILS_ID from sTB_SITE_LIC sl 
									inner join TB_SITE_LIC_DETAILS ld on sl.SITE_LIC_ID = ld.SITE_LIC_ID and ld.VALID_FROM is not null
									inner join TB_FOR_SALE fs on ld.FOR_SALE_ID = fs.FOR_SALE_ID and fs.IS_ACTIVE = 0
			...
			--@ck2 counts how many reviews can be added to current lic
			set @ck2 = (select d.REVIEWS_ALLOWANCE - count(review_id) from TB_SITE_LIC_DETAILS d inner join
							 sTB_SITE_LIC_REVIEW lr on lr.SITE_LIC_DETAILS_ID = @lic_det_id
								and lr.SITE_LIC_DETAILS_ID = d.SITE_LIC_DETAILS_ID
							 group by d.REVIEWS_ALLOWANCE
							 )--count how many reviews can still be added
			if @ck != 0 -- review is already in a site lic
			begin
				set @ck = (select count(review_id) from sTB_SITE_LIC_REVIEW where REVIEW_ID = @review_id and SITE_LIC_ID = @lic_id)
				if @ck = 1 set @res = -3 --review already in this site_lic
			...
			begin --all is well, let's do something!
				...
				begin --write success log
					...
					declare @tvsl_BL_ACCOUNT_CODE nvarchar(50) = (select BL_ACCOUNT_CODE from sTB_SITE_LIC where SITE_LIC_ID = @lic_id)
					declare @tvsl_BL_AUTH_CODE nvarchar(50) = (select BL_AUTH_CODE from sTB_SITE_LIC where SITE_LIC_ID = @lic_id)
					declare @tvsl_BL_TX nvarchar(50) = (select BL_TX from sTB_SITE_LIC where SITE_LIC_ID = @lic_id)
					declare @tvsl_BL_CC_ACCOUNT_CODE nvarchar(50) = (select BL_CC_ACCOUNT_CODE from sTB_SITE_LIC where SITE_LIC_ID = @lic_id)
					declare @tvsl_BL_CC_AUTH_CODE nvarchar(50) = (select BL_CC_AUTH_CODE from sTB_SITE_LIC where SITE_LIC_ID = @lic_id)
					declare @tvsl_BL_CC_TX nvarchar(50) = (select BL_CC_TX from sTB_SITE_LIC where SITE_LIC_ID = @lic_id)
					
					declare @tvr_BL_ACCOUNT_CODE nvarchar(50) = (select BL_ACCOUNT_CODE from sTB_REVIEW where REVIEW_ID = @review_id)
					declare @tvr_BL_AUTH_CODE nvarchar(50) = (select BL_AUTH_CODE from sTB_REVIEW where REVIEW_ID = @review_id)
					declare @tvr_BL_TX nvarchar(50) = (select BL_TX from sTB_REVIEW where REVIEW_ID = @review_id)
					declare @tvr_BL_CC_ACCOUNT_CODE nvarchar(50) = (select BL_CC_ACCOUNT_CODE from sTB_REVIEW where REVIEW_ID = @review_id)
					declare @tvr_BL_CC_AUTH_CODE nvarchar(50) = (select BL_CC_AUTH_CODE from sTB_REVIEW where REVIEW_ID = @review_id)
					declare @tvr_BL_CC_TX nvarchar(50) = (select BL_CC_TX from sTB_REVIEW where REVIEW_ID = @review_id)
			...
			begin
				...
				begin
					...
					begin
						...
						set @initialModelType = (select SITE_LIC_MODEL from sTB_SITE_LIC 
						where SITE_LIC_ID = @LIC_ID)
...
BEGIN
    ...
    set @det_id = (select top 1 ld.SITE_LIC_DETAILS_ID from TB_SITE_LIC_DETAILS ld 
       ...
       select * from sTB_REVIEW r
              inner join sTB_SITE_LIC_REVIEW lr on r.REVIEW_ID = lr.REVIEW_ID and SITE_LIC_ID = @lic_id and SITE_LIC_DETAILS_ID != @det_id
       --second, reviews that were added to the currently active SITE_LIC_DETAILS
       select * from sTB_REVIEW r
              inner join sTB_SITE_LIC_REVIEW lr on r.REVIEW_ID = lr.REVIEW_ID and SITE_LIC_ID = @lic_id and SITE_LIC_DETAILS_ID = @det_id
       --accounts in the license
       select * from sTB_CONTACT c
              inner join sTB_SITE_LIC_CONTACT lc on c.CONTACT_ID = lc.CONTACT_ID and lc.SITE_LIC_ID = @lic_id
       --license admins
       select * from sTB_CONTACT c
...
BEGIN
    ...
    set @det_id = (select top 1 ld.SITE_LIC_DETAILS_ID from TB_SITE_LIC_DETAILS ld 
	   ...
	   select c.CONTACT_ID, c.CONTACT_NAME, c.EMAIL, max(lt.CREATED) as LAST_LOGIN
		...
		left join sTB_SITE_LIC_CONTACT sc on c.CONTACT_ID = sc.CONTACT_ID
		left join sTB_SITE_LIC l on sc.SITE_LIC_ID = l.SITE_LIC_ID
		where c.CONTACT_ID in (select CONTACT_ID from sTB_SITE_LIC_CONTACT where SITE_LIC_ID = @lic_id)	
...
/*
	...
	inner join sTB_CONTACT c on c.CONTACT_ID = s_l_a.CONTACT_ID
...
BEGIN
	...
	inner join sTB_SITE_LIC s_l on s_l.SITE_LIC_ID = s_l_c.SITE_LIC_ID
...
BEGIN
	...
	SELECT TOP 1 *, c.CONTACT_NAME as ADMIN_NAME, ld.DATE_CREATED as DATE_PACKAGE_CREATED from sTB_SITE_LIC sl 
		inner join TB_SITE_LIC_DETAILS ld on sl.SITE_LIC_ID = ld.SITE_LIC_ID and ld.VALID_FROM is not null
		inner join TB_FOR_SALE fs on ld.FOR_SALE_ID = fs.FOR_SALE_ID and fs.IS_ACTIVE = 0
		inner join TB_SITE_LIC_ADMIN la on sl.SITE_LIC_ID = la.SITE_LIC_ID and CONTACT_ID = @admin_ID
		inner join stb_CONTACT c on c.CONTACT_ID = @admin_ID
	Order by ld.VALID_FROM desc	
...
BEGIN
    ...
    -- first results set: currently active license TB_SITE_LIC_DETAILS.VALID_FROM is something and FOR_SALE.IS_ACTIVE = false
	SELECT TOP 1 *, c.CONTACT_NAME as ADMIN_NAME, ld.DATE_CREATED as DATE_PACKAGE_CREATED, 1 as SITE_LIC_MODEL from sTB_SITE_LIC sl 
		inner join TB_SITE_LIC_DETAILS ld on sl.SITE_LIC_ID = ld.SITE_LIC_ID and ld.VALID_FROM is not null
		inner join TB_FOR_SALE fs on ld.FOR_SALE_ID = fs.FOR_SALE_ID and fs.IS_ACTIVE = 0
		inner join TB_SITE_LIC_ADMIN la on sl.SITE_LIC_ID = la.SITE_LIC_ID and CONTACT_ID = @admin_ID
		inner join stb_CONTACT c on c.CONTACT_ID = @admin_ID
...
BEGIN
    ...
    -- first results set: currently active license TB_SITE_LIC_DETAILS.VALID_FROM is something and FOR_SALE.IS_ACTIVE = false
	SELECT TOP 1 *, c.CONTACT_NAME as ADMIN_NAME, ld.DATE_CREATED as DATE_PACKAGE_CREATED, SITE_LIC_MODEL from sTB_SITE_LIC sl 
		inner join TB_SITE_LIC_DETAILS ld on sl.SITE_LIC_ID = ld.SITE_LIC_ID and ld.VALID_FROM is not null
		inner join TB_FOR_SALE fs on ld.FOR_SALE_ID = fs.FOR_SALE_ID and fs.IS_ACTIVE = 0
		inner join TB_SITE_LIC_ADMIN la on sl.SITE_LIC_ID = la.SITE_LIC_ID and CONTACT_ID = @admin_ID
		inner join stb_CONTACT c on c.CONTACT_ID = @admin_ID
...
BEGIN
	...
	inner join sTB_SITE_LIC sl on sl.SITE_LIC_ID = ld.SITE_LIC_ID
	where SITE_LIC_DETAILS_ID = @SITE_LIC_DETAILS_ID
...
BEGIN
	...
	begin
		set @ck = 
		(select count(review_id) from sTB_SITE_LIC_REVIEW 
		...
		begin --all is well, let's do something!
			...
			delete from sTB_SITE_LIC_REVIEW
			where REVIEW_ID = @review_id
...
BEGIN
	...
	select @DEST_CID = contact_id from sTB_CONTACT c where @CONTACT_ID != c.CONTACT_ID and @EMAIL = c.EMAIL
	...
	select @CREDIT = c.MONTHS_CREDIT from sTB_CONTACT c where @CONTACT_ID = c.CONTACT_ID and (@EMAIL != c.EMAIL OR c.EMAIL is null)
	...
	select @oldDate = c.[EXPIRY_DATE] from  sTB_CONTACT c where c.CONTACT_ID = @DEST_CID
	UPDATE c set c.EXPIRY_DATE = CASE 
			     ...
			     ,c.MONTHS_CREDIT = CASE 
									...
									ELSE 0
								  END
		from sTB_CONTACT c where c.CONTACT_ID = @DEST_CID
	declare @chk int
	select @chk = COUNT(CONTACT_ID) from sTB_CONTACT where @DEST_CID = CONTACT_ID 
										and (
	...
	if @chk = 1
		...
		DELETE from sTB_CONTACT where CONTACT_ID = @CONTACT_ID --ghost is now empty, why keep it?
...
SET NOCOUNT ON
	...
	begin
		...
		from sTB_ATTRIBUTE a inner join sTB_ATTRIBUTE_SET a_s
...
BEGIN
	...
	BEGIN
		...
		BEGIN
			...
			INSERT into sTB_LOGON_TICKET(TICKET_GUID, CONTACT_ID, REVIEW_ID)
...
if (@chk = 1) --user is a site admin, current review might not have it as a member, so we need to do more work
 BEGIN
  declare @RID int = (select Review_id from sTB_LOGON_TICKET 
...
Select c.Password  
From TB_CONTACT c
	inner join sTB_LOGON_TICKET t on c.CONTACT_ID = t.CONTACT_ID and t.STATE = 1
...
BEGIN
	...
	BEGIN
		...
		INNER JOIN TB_SET S ON S.SET_ID = RS.SET_ID
		INNER JOIN TB_SET_TYPE ON TB_SET_TYPE.SET_TYPE_ID = S.SET_TYPE_ID
		inner join sTB_MANAGEMENT_SETTINGS ms on RS.REVIEW_ID = ms.PUBLIC_CODESETS_REVIEW_ID 
		ORDER BY RS.REVIEW_ID, RS.SET_ORDER, RS.SET_ID
	END
END
GO
...
BEGIN
    ...
    -- Insert statements for procedure here
	Select * from sTB_TEMPLATE_REVIEW order by TEMPLATE_REVIEW_ID
	
	Select * from sTB_TEMPLATE_REVIEW tr
		inner join sTB_TEMPLATE_REVIEW_SET trs on tr.TEMPLATE_REVIEW_ID = trs.TEMPLATE_REVIEW_ID
...
IF @@ROWCOUNT >= 1 
	...
	EXEC	@return_value = sst_LogonTicket_Insert
			@Contact_ID = @userId,
			@Review_ID = @reviewId,
			@Client = @Client,
			@GUID = @GUI OUTPUT
