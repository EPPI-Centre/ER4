USE[Reviewer]
GO
/****** Object:  StoredProcedure [dbo].[st_AttributeSet]    Script Date: 12/06/2020 08:31:31 ******/
SET ANSI_NULLS ON
GO
...
USE [Reviewer]
GO
/****** Object:  StoredProcedure [dbo].[st_AllAttributesInSet]    Script Date: 12/06/2020 08:46:15 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

ALTER   procedure [dbo].[st_AllAttributesInSet]
(
	@SET_ID INT
)
