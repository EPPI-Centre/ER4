...
IF COL_LENGTH('dbo.TB_ATTRIBUTE', 'IS_EXCLUSIVE') IS NULL
BEGIN
	ALTER TABLE [dbo].[TB_ATTRIBUTE] 
	ADD IS_EXCLUSIVE bit default 0 not null
END
GO
...
/****** Object:  StoredProcedure [dbo].[st_AllAttributesInSet]    Script Date: 19/02/2026 10:20:31 ******/
SET ANSI_NULLS ON
GO
...
SELECT TB_ATTRIBUTE_SET.ATTRIBUTE_SET_ID, TB_ATTRIBUTE_SET.SET_ID, TB_ATTRIBUTE_SET.ATTRIBUTE_ID, TB_ATTRIBUTE_SET.PARENT_ATTRIBUTE_ID,
	...
	ORIGINAL_ATTRIBUTE_ID, OLDEST_KNOWN_ATTRIBUTE_ID, IS_EXCLUSIVE
...
/****** Object:  StoredProcedure [dbo].[st_AttributeSetDeleteWarning]    Script Date: 19/02/2026 10:31:00 ******/
SET ANSI_NULLS ON
GO
