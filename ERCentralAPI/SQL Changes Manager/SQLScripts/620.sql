...
/****** Object:  StoredProcedure [dbo].[st_RemoveCreditPurchaseIDForOpenAI]    Script Date: 21/10/2024 13:47:37 ******/
SET ANSI_NULLS ON
GO
...
SET NOCOUNT ON
	...
	if @REVIEW_ID = 0 
	begin
		-- it's a site license so log it in TB_SITE_LIC_LOG
		...
		insert into TB_SITE_LIC_LOG (SITE_LIC_DETAILS_ID, CONTACT_ID, AFFECTED_ID, CHANGE_TYPE, 
			DATE, REASON)
		values (@latest_package_id, @CONTACT_ID, 0, 'remove Robot credit', getdate(), 
...
/****** Object:  StoredProcedure [dbo].[st_SetCreditPurchaseIDForOpenAI]    Script Date: 21/10/2024 13:48:10 ******/
SET ANSI_NULLS ON
GO
