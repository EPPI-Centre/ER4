...
/****** Object:  StoredProcedure [dbo].[st_ReportColumnCodeList]    Script Date: 25/07/2025 12:06:47 ******/
SET ANSI_NULLS ON
GO
...
SET NOCOUNT ON
	...
	-- for the case where the code is in a deleted coding tool 
	and SET_ID in 
	(select SET_ID from TB_REVIEW_SET where REVIEW_ID = @review_id)

	-- set codeExists for the Coding tools
	update @TV_REPORT_COLUMN_CODE
	set CODE_EXISTS = 1
	where ATTRIBUTE_ID = 0
	-- to confirm the set is in the review
...
/****** Object:  StoredProcedure [dbo].[st_ReportData]    Script Date: 25/07/2025 14:12:38 ******/
SET ANSI_NULLS ON
GO
