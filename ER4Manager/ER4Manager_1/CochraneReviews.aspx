<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="CochraneReviews.aspx.cs" Inherits="CochraneReviews" Title="Cochrane reviews" %>
    ...
    <br />
            ...
            <asp:Panel ID="pnlCochraneReviews" runat="server">
                ...
                <telerik:RadGrid ID="radGVCochraneReviews" runat="server" 
                    AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" 
                    CssClass="Grid" Height="350px" 
                    onitemdatabound="radGVCochraneReviews_ItemDataBound" 
                    onneeddatasource="radGVCochraneReviews_NeedDataSource" 
                    onpageindexchanged="radGVCochraneReviews_PageIndexChanged" PageSize="12" 
            ...
            <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" OnAjaxRequest="RadAjaxManager1_AjaxRequest">
                <AjaxSettings>
                    <telerik:AjaxSetting AjaxControlID="radGVCochraneReviews">
                        <UpdatedControls>
                            <telerik:AjaxUpdatedControl ControlID="radGVCochraneReviews" LoadingPanelID="RadAjaxLoadingPanel1" />
                        </UpdatedControls>
                    </telerik:AjaxSetting>
