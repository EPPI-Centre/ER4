...
public partial class NonShareableReviews : System.Web.UI.Page
{
            ...
            if (Utils.GetSessionString("IsAdm") == "True")
            {
                if (!IsPostBack)
                {
                    ...
                    if (radTs != null)
                    {
                        ...
                        radTs.Tabs[2].Tabs[1].Selected = true;
                    ...
                    if (lbl1 != null)
                    {
                        lbl1.Text = "List of Non-shareable reviews";
                    }
    ...
    protected void radGVNonShareableReviews_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
    {
        bool shareable = false;
        DataTable dt = new DataTable();
        System.Data.DataRow newrow;
        ...
        radGVNonShareableReviews.DataSource = dt;
    }
    protected void RadAjaxManager1_AjaxRequest(object sender, AjaxRequestEventArgs e)
    {
        if (e.Argument.IndexOf("FilterGrid") != -1)
        {
            radGVNonShareableReviews.Rebind();
        }
    }
    protected void radGVNonShareableReviews_PageIndexChanged(object sender, GridPageChangedEventArgs e)
    {
        bool shareable = false;
        if (tbFilter.Text == "")
        {
        ...
        {
            radGVNonShareableReviews.Rebind(); // fires NeedDataSource
        }
    }
    protected void radGVNonShareableReviews_ItemDataBound(object sender, GridItemEventArgs e)
    {
