...
function openAdminList(ID) 
{
    ...
    DetailsWindow = window.open(theURL, windowName, strFeatures);
        ...
        <asp:Panel ID="pnlSiteLicences" runat="server">
            ...
            <asp:LinkButton ID="lbNewSiteLicense" runat="server" 
                onclick="lbNewSiteLicense_Click">New license</asp:LinkButton>
            <asp:GridView ID="gvSiteLicenses" runat="server" AutoGenerateColumns="False" 
                ...
                onpageindexchanging="gvSiteLicenses_PageIndexChanging">
                <Columns>
                                                            ...
                                                            <table style="width:100%;">
                                                                <tr>
                                                                    <td style="width: 33%" valign="middle">
                                                                        Reviews added to the license will get these codes unless they already have 
                                                                        codes.<br />
                                                                        <br />
                                        ...
                                        <table ID="Table2" border="1" cellpadding="1" cellspacing="1" width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <td style="background-color: #B6C6D6; width: 25%;">
                                                    For sale ID</td>
                                                <td ;="" style="width: 25%; background-color: #FFFFCC">
                                                    &nbsp;&nbsp;<asp:Label ID="lblForSaleID" runat="server" Text="N/A"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="background-color: #B6C6D6; width: 25%;">
                                            ...
                                            <tr>
                                                <td style="background-color: #B6C6D6; width: 25%;">
                                                    Valid from (enter for Activation)</td>
...
&nbsp;
                                                ...
                                                <td style="background-color: #B6C6D6; width: 25%;">
                                                    Expiry date (enter for Activation)</td>
                                                <td ;="" style="width: 25%; background-color: #99FF99">
                                            ...
                                            <tr>
                                                ...
                                                <td style="background-color: #B6C6D6; width: 25%;">
                                                    Reason for expiry extension</td>
                                                <td ;="" style="width: 25%; background-color: #FFFFCC">
                                            ...
                                            <tr>
                                                <td style="background-color: #B6C6D6; width: 25%;">
                                                    Description of extension</td>
                                                <td ;="" colspan="3" style="background-color: #FFFFCC">
                                                    <asp:TextBox ID="tbDescription" runat="server" Width="90%"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="background-color: #B6C6D6; width: 25%;">
                ...
                <table style="width:100%;">
                    ...
                    <tr>
                        ...
                        <td style="background-color: #ffffff; width: 10%;">
                            &nbsp;</td>
                        <td style="background-color: #ffffff; width: 45%;">
                            <b>Reviews in previous packages</b></td>
                    </tr>
                    <tr>
                        <td style="background-color: #ffffff; width: 45%;" valign="top">
